 ...
 */
final class Version20210924133502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE film_log ADD COLUMN timestamp DATETIME NOT NULL');
        $this->addSql('ALTER TABLE film_log ADD COLUMN actiontype VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE film_log ADD COLUMN film_id INTEGER NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_1A3CCDA8567F5183 ON film_genre (film_id)');
        $this->addSql('CREATE INDEX IDX_1A3CCDA84296D31F ON film_genre (genre_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__film_log AS SELECT id FROM film_log');
        $this->addSql('DROP TABLE film_log');
        $this->addSql('CREATE TABLE film_log (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        $this->addSql('INSERT INTO film_log (id) SELECT id FROM __temp__film_log');
