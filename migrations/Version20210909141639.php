 ...
 */
final class Version20210909141639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, feature_film_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, genres VARCHAR(255) DEFAULT NULL, director VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_8244BE226768CA8A FOREIGN KEY (feature_film_id) REFERENCES feature_film (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__film AS SELECT id, feature_film_id, title, description FROM film');
        $this->addSql('DROP TABLE film');
        $this->addSql('CREATE TABLE film (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, feature_film_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL, description VARCHAR(255) DEFAULT NULL, director_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO film (id, feature_film_id, title, description) SELECT id, feature_film_id, title, description FROM __temp__film');
        $this->addSql('DROP TABLE __temp__film');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8244BE222B36786B ON film (title)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8244BE226768CA8A ON film (feature_film_id)');
